  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AuthBloc, AuthState>(builder: (ctx, state) {
      final currentTier  = state is AuthAuthenticated
          ? state.user.userTier
          : UserTier.free;
      final trialExpired = state is AuthAuthenticated
          ? state.user.isTrialExpired
          : false;

      // Block back navigation for trial-expired users — they must upgrade.
      return PopScope(
        canPop: !trialExpired,
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            automaticallyImplyLeading: !trialExpired,
            leading: trialExpired
                ? null
                : IconButton(
            ...
            child: Column(children: [
                  ...
                  child: const Row(children: [
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 2),
                        Text(
                          'Upgrade to continue using Jyotish AI and unlock your full cosmic potential.',
              ...
              _PlanCard(
                ...
                features: const [
                  ...
                  'Auspicious muhurtham alerts',
                ],
                restrictions: const [
                  'No additional family profiles',
                ],
                onSubscribe: () => _showDemoDialog(context, 'Basic', '₹99/month'),
              ),
              const SizedBox(height: 16),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: isCurrent ? AppColors.textHint : Colors.white,
